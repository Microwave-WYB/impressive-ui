...
from impressive_ui.gtk import MutableState, State, Conditional, ReactiveSequence
...
class CounterModel:
    ...
    auto_increment: MutableState[bool] = field(
        default_factory=lambda: MutableState(False)
    )
